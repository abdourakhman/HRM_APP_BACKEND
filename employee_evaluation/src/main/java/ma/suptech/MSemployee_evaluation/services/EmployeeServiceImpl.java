...
import ma.suptech.MSemployee_evaluation.client.OrganizationRestClient;
...
import ma.suptech.MSemployee_evaluation.repositories.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public List<Employee> findByManagerID(Long id) {
        List<Employee> employees;
        employees = employeeRepository.findAll().stream().filter(employee -> employee.getManagerID().equals(id)).toList();
